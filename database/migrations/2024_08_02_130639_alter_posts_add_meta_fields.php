...
return new class extends Migration
{
    ...
    {
        Schema::table('filament_news_posts', static function (Blueprint $table) {
            $table->addMeta();
        });

        DB::table('filament_news_posts')->orderBy('id')->chunk(100, function ($posts) {
            foreach ($posts as $post) {
                ...
                DB::table('filament_news_posts')->where('id', $post->id)->update([
